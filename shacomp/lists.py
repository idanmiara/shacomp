...
interchangeable_ext_sets = [('.mp4', '.m4a'), ('.mpg', '.vob'), ('.doc', '.txt'), ('.bup', '.ifo')]


def is_interchangeable_ext(ext1, ext2):
    if ext1 == ext2:
        return True
    for s in interchangeable_ext_sets:
