...
if not nonconsistant_exts:
    delete_junk(global_dict, data_dir_name=data_path, junk_sha_list=junk_sha_list, delete_junk_filenames=True, sha_to_delete={zero_sha})
save_sha_tup_list(junk_sha_list, os.path.join(base_path, '_junk.sha512'))
